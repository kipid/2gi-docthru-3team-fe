        ...
        <section>
          ...
          <ol>
            ...
            <li>
              ...
              <p>
                <span>
                  개발 환경에서만 로그를 출력하여 개발자가 개발 중에 발생하는 오류를 빠르게 파악할 수 있도록 로깅 기능을 구현하였습니다.
                </span>
              </p>
            </li>
            <li>
              ...
              <p>
                <span>
                  에러 발생 시 사용자에게 메시지를 제공하고, 개발자에게는 상세한 에러 로그를 제공하여 빠르게 오류를 수정할 수
                  있도록 커스텀 에러 핸들러를 구현하였습니다.
                </span>
              </p>
            </li>
            <li>
              <strong>트리거 및 저장 프로시저 활용</strong>
              <p>
                <span>
                  데이터베이스 트리거와 저장 프로시저를 활용하여 데이터의 일관성을 유지하고 데이터베이스의 성능을 향상시켰습니다.
                </span>
              </p>
            </li>
          </ol>
